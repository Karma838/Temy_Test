...
*/
  ...
  /*
    ...
    Написать регулярное выражение которое найдет:
      1. Все слова. /\w+
      2. Все совпадения букв от a до e,  /[a-e]
      3. Года, например 2004 \d{4}
      4. Слова обернутые в [квадратныеКавычки] /\[\w+\]/g
      5. Все форматы файлов .jpg / .png / .gif  \.\w{3}
      6. Все email com.ua \b\w+@\w+\.com\.ua
      7. Все слова написанные с большой буквы  \b[A-Z]\w+
  */
