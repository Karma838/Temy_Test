...
*/
  ...
  */
  ...
  //     console.log( 'myNewHamster.animal:', myNewHamster, myNewHamster2.animal );
  ...
  */
    ...
    //   constructor.apply( obj, argsArray.slice(1), argsArray.slice(1) ); // Вызовем конструктор и передадим в него наши аргументы функции
    //   return obj; // Вернем готовый обьект
    // }

    // let testProto = newZ( Person );
